...
FFLAGS = -ffree-line-length-none -ffree-line-length-0 -Wno-unused-dummy-argument -g -O -ffpe-trap=invalid,overflow,zero -w

LDFLAGS = -L/opt/homebrew/Cellar/gcc/14.1.0_2/lib/gcc/14 -Wl,-rpath,/opt/homebrew/Cellar/gcc/14.1.0_2/lib/gcc/14
...
CrunchMain : ${OBJSF}
	-${FLINKER} -o CrunchTope ${OBJSF} ${PETSC_FORTRAN_LIB} ${PETSC_LIB} ${FFLAGS} ${LDFLAGS}
